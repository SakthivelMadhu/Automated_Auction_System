...
public class Main {
	...
	static {
		System.out.println("+----------------------------------------------+"+JavaConsoleColor.RED);
		System.out.println("|**********************************************|");
		System.out.println("|********"+ JavaConsoleColor.BOLDON+ " Hello Welcome to Latest Auction  "+ JavaConsoleColor.BOLDOFF+JavaConsoleColor.RED +"********|");
	...
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
				...
				case 1:{
						while(true) {
							...
							try {
								...
								System.out.print("\n Welcome Admin "+adminProfile.getaFirstName());
			...
			case 2:
					{
						System.out.println(JavaConsoleColor.BOLDON+JavaConsoleColor.RED+"Hey Seller.."+JavaConsoleColor.BOLDOFF+JavaConsoleColor.RESET+"\n");
				...
				case 3:
					{
						System.out.println(JavaConsoleColor.BOLDON+JavaConsoleColor.RED+"Hey Buyer.."+JavaConsoleColor.BOLDOFF+JavaConsoleColor.RESET+"\n");
						System.out.println("1. New user? register..");
						System.out.println("2. Login..");
						System.out.println("3. Exit");
